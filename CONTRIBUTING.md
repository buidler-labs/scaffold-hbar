# Welcome to Scaffold-HBAR Contributing Guide

Thank you for investing your time in contributing to Scaffold-HBAR!

This guide aims to provide an overview of the contribution workflow to help us make the contribution process effective for everyone involved.

## About the Project

Scaffold-HBAR is a minimal and forkable repo providing builders with a starter kit to build decentralized applications on Hedera.

Read the [README](README.md) to get an overview of the project.

### Vision

The goal of Scaffold-HBAR is to provide the primary building blocks for a decentralized application.
...
Scan through our [existing issues](https://github.com/buidler-labs/scaffold-hbar/issues) to find one that interests you.
