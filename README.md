...
A Hedera-ready monorepo for building dApps with Next.js, Hardhat or Foundry, and Hedera networks (testnet, mainnet, local fork). Generated by [create-scaffold-hbar](https://github.com/hedera-dev/create-scaffold-hbar) or used as the production template when you run `npx create-scaffold-hbar@latest`.
