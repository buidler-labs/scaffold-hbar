...
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `make test` / `yarn test` / `forge test` | Default Forge profile: unit tests with **mock HSS** etched at `0x16b` (`ScheduledVault`, factory, `MemejobDCAStrategy` tests).                                                                                                                                                         |
...
- **Localhost:** `make chain` or `yarn chain` starts **vanilla Anvil** (chain id 31337). Default deploy uses keystore `**scaffold-eth-default`** (imported by the Makefile with password `localhost`).
  ```bash
  yarn deploy
  ```
