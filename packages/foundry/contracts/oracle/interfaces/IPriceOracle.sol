...
/// @dev Adapters bind themselves to a single BASE/QUOTE pair and provider. Implementations must return prices
///      scaled to 18 decimals so consumers can use one conversion path across Chainlink, Supra, Pyth, or mocks.
interface IPriceOracle {
    ...
    /// @notice Reads the latest validated and normalized price for this adapter's configured pair.
