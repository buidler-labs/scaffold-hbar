...
axelar-help:
	...
	@echo "  Optional mint test supply:        make axelar-mint-hedera AMOUNT=100000000"
	@echo "                                    make axelar-mint-sepolia AMOUNT=100000000"
	@echo "  Associate Hedera receiver:        make axelar-associate-hedera"
	@echo "  Test Hedera -> Sepolia:           make axelar-approve-hedera AMOUNT=100000000"
	@echo "                                   make axelar-send-from-hedera AMOUNT=100000000 [RECIPIENT=0x...]"
	@echo "  Test Sepolia -> Hedera:           make axelar-send-from-sepolia AMOUNT=100000000 [RECIPIENT=0x...]"
	@echo "  Recovery add gas:                make axelar-add-gas-hedera TX_HASH=0x... LOG_INDEX=3"
...
axelar-associate-hedera:
	@cd "$(FOUNDRY_DIR)" && bash "$(BRIDGE_AXELAR_SH)" associate-hedera
...
axelar-add-gas-hedera:
	@cd "$(FOUNDRY_DIR)" && TX_HASH="$(TX_HASH)" LOG_INDEX="$(LOG_INDEX)" HEDERA_ADD_GAS_NATIVE_FEE="$(HEDERA_ADD_GAS_NATIVE_FEE)" bash "$(BRIDGE_AXELAR_SH)" add-gas-hedera
