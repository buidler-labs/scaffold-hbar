...
contract DcaExecutor is IDcaHandler {
    ...
    event SwapExecuted(uint256 indexed planId, uint256 amountIn, uint256 amountOut, address indexed tokenOut);
    ...
    function _executeSwap(uint256 planId, uint256 amountIn, address tokenOut, uint256 minAmountOut) internal {
